...
class Ndan1gachasonlarnichiqarishProcessor:
    """
    Auto-generated handler for: "N dan 1 gacha sonlarni chiqarish.",
    """
    def __init__(self):
    ...
    def get_summary(self):
        return {
            "handler": "Ndan1gachasonlarnichiqarishProcessor",
...
def main():
    print("=" * 50)
    print("🚀 Initializing module for: "N dan 1 gacha sonlarni chiqarish.",")
    print("=" * 50)
    
    processor = Ndan1gachasonlarnichiqarishProcessor()
